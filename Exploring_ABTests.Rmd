---
title: "Exploring Common Challenges in AB Testing"
subtitle: "A guide for making the most out of your A/B testing cycles"
output: 
  pdf_document: 
    number_sections: yes
---
...
Why? Let's take a look below to illustrate: 
...
# Too Many Comparisons: The Multiple Comparison Problem
...
> **To calculate the increase in risk of a faslse positive result, there is a simple formula based on the number of hypotheses you are testing ($N$) at a significance level of 0.05 (false-positive rate):**
...
The below examples visualize different effect sizes that all have statistically significant results (p-values < 0.05). 
